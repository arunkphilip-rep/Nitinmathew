...
const skills = [
  { name: 'Investment Banking', icon: TrendingUp, color: 'from-purple-300 to-pink-300', bgColor: 'from-purple-25 to-pink-25' },
  { name: 'Middle Office Operations', icon: BarChart3, color: 'from-blue-300 to-cyan-300', bgColor: 'from-blue-25 to-cyan-25' },
  { name: 'Financial Planning', icon: Calculator, color: 'from-green-300 to-emerald-300', bgColor: 'from-green-25 to-emerald-25' },
  { name: 'Working Capital Lending', icon: Wallet, color: 'from-orange-300 to-red-300', bgColor: 'from-orange-25 to-red-25' },
  { name: 'Budgeting', icon: PiggyBank, color: 'from-indigo-300 to-purple-300', bgColor: 'from-indigo-25 to-purple-25' },
  { name: 'Cash Flow Management', icon: Target, color: 'from-teal-300 to-blue-300', bgColor: 'from-teal-25 to-blue-25' },
];
